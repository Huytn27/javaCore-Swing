...
public class BangChon extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tim gì ");

        jLabel2.setText("Thay thể :");

        jLabel3.setText("set size :");

        jCheckBox1.setText("Thay thế tất cả");

        jRadioButton1.setText("Xanh");

        jRadioButton2.setText("Đỏ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jCheckBox1.isSelected())
            m.setText(s.replaceAll(jTextField1.getText(), jTextField2.getText()));
        else
            m.setText(s.replaceFirst(jTextField1.getText(), jTextField2.getText()));
