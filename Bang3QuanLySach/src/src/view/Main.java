...
public class Main extends javax.swing.JFrame {
    ...
    private int getDauSach(int maBD){
        int count=0;
        for (int i = 0; i < tmQL.getRowCount(); i++) {
            int ma1=Integer.parseInt(tmQL.getValueAt(i, 0).toString()); //hàng i cột 0
            if(ma1==maBD) // nếu mã bạn đọc truyền vào trùng với mã bạn đọc ở bảng 
                count++;
        }
        return count;
    }
...
//    }
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        if(themQL){
            ...
            int maBD=Integer.parseInt(maBDx); // lấy ở combobox
