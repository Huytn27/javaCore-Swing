...
public class BangChon extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Tran van hung", "Tran van ty", "Tran van teo", " " };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String s = "Tinh boi " + jList1.getSelectedValue() + "\n";
        int tong = 0;
        if(jRadioButton1.isSelected()){
            for (Integer x : m.getNum()) {
                tong += x;
            }
            s += tong;
        }
        if(jRadioButton2.isSelected())
            s += "Max la " + Collections.max(m.getNum());
        if(jRadioButton3.isSelected())
            s += "Min la " + Collections.min(m.getNum());
        m.setText(s);
